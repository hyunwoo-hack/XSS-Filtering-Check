...
export default class Xss_Bayev extends Payload_Ztel{
    ...
    async attack_naut(param){
        ...
        if(!await this.attack_factory(this.url, mani_param, this.delay, this.cookie, null, cpst_target))this.#error_sender("필터링으로 인한 페이로드 생성 불가");
    }
}